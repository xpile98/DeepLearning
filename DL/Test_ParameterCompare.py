...
aux_output = keras.layers.Dense(1, name='aux_output')(hidden2)                  # aux_output 추가
model = keras.Model(inputs=[input_A, input_B], outputs=[output, aux_output])    # aux_output 추가
